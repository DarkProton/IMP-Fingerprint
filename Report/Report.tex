...
\;
		...
		The results of the ATD function are not as encouraging. The primary problem appears lies with the system that determines how the various cases should be dealt with.
